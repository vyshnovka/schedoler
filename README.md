...
Just simply download the installer from the latest released version in **Releases**.   
That's all.   
   
If there is no suitable installer, try following steps below to rebuild this project.   
